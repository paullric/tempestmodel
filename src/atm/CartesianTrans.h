...
///	<summary>
///		Coordinate transformation functions on the Cartesian grid.
///	</summary>
class CartesianTrans {
...
public:
	...
	///		nP (OUT) - Single cartesian panel 0
	///	</parameters>
