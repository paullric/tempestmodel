...
#ifndef _VERTICALDYNAMICSFLL_H_
#define _VERTICALDYNAMICSFLL_H_
...
protected:
	...
	///	</summary>
	typedef int FComp;
	static const FComp FWIx = 0;
	static const FComp FZIx = 1;

	static const FComp FTot = 2;
...
#ifdef USE_JFNK_PETSC
PetscErrorCode VerticalDynamicsFLL_FormFunction(
	SNES snes,
	Vec x,
	Vec f,
	void * pDyn
