...
void GridGLL::Initialize() {
	...
	// Fourth order coefficients to machine truncation
	if (m_nHorizontalOrder == 4) {
...
/*
	...
	if (m_nHorizontalOrder == 4) {
		dGL[0] = 0.0;
		dGL[1] = 2.76393202250021507992983060831E-1;
		dGL[2] = 7.23606797749978492007016939169E-1;
		dGL[3] = 1.0;
	}
	...
	for (int i = 0; i < m_nHorizontalOrder; i++) {
		...
		if (m_nHorizontalOrder == 4) {
			if (i == 0) {
				dCoeffs[0] = -6.0;
				dCoeffs[1] =  8.09016994374947451262869435595E0;
				dCoeffs[2] = -3.09016994374947451262869435595E0;
				dCoeffs[3] =  1.0;
			} else if (i == 1) {
				dCoeffs[0] = -1.61803398874989490252573887119E0;
				dCoeffs[1] =  0.0;
				dCoeffs[2] =  2.23606797749978980505147774238E0;
				dCoeffs[3] = -6.18033988749894902525738871191E-1;
			} else if (i == 2) {
				dCoeffs[0] =  6.18033988749894902525738871191E-1;
				dCoeffs[1] = -2.23606797749978980505147774238E0;
				dCoeffs[2] =  0.0;
				dCoeffs[3] =  1.61803398874989490252573887119E0;
			} else {
				dCoeffs[0] = -1.0;
				dCoeffs[1] =  3.09016994374947451262869435595E0;
				dCoeffs[2] = -8.09016994374947451262869435595E0;
				dCoeffs[3] =  6.0;
			}
		}
