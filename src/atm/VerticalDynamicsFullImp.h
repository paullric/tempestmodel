///////////////////////////////////////////////////////////////////////////////
///
///	\file    VerticalDynamicsFullImp.h
///	\author  Paul Ullrich
...
#ifndef _VERTICALDYNAMICSV2_H_
#define _VERTICALDYNAMICSV2_H_
...
protected:
	...
	///	<summary>
	///		Vertical velocity curl terms on model interfaces (alpha).
	///	</summary>
	DataArray1D<double> m_dCurlTermAREdge;

	///	<summary>
	///		Vertical velocity curl terms on model interfaces (beta).
	///	</summary>
	DataArray1D<double> m_dCurlTermBREdge;
