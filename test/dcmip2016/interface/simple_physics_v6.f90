...
!            J. Adv. Model. Earth Syst., Vol. 4, M04001,
!            doi:10.1029/2011MS000099
!-----------------------------------------------------------------------

SUBROUTINE SIMPLE_PHYSICS( &
  pcols, pver, dtime, lat, t, q, u, v, pmid, pint, pdel, rpdel, ps, precl, test, RJ2012_precip, TC_PBL_mod) &
  BIND(c, name = "simple_physics")
