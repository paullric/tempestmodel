...
public:
	...
	HeldSuarezTest(
		double dZtop,
		PerturbationType ePerturbationType = PerturbationType_Exp
	) :
...
public:
	...
	virtual void EvaluatePointwiseState(
		...
		double dRCosLat = phys.GetEarthRadius() * cos(dLat);
...
/*
	HeldSuarezTest::PerturbationType ePerturbationType;
	STLStringHelper::ToLower(strPerturbationType);
	if (strPerturbationType == "none") {
		ePerturbationType = HeldSuarezTest::PerturbationType_None;
	} else if (strPerturbationType == "exp") {
		ePerturbationType = HeldSuarezTest::PerturbationType_Exp;
	} else if (strPerturbationType == "sfn") {
		ePerturbationType = HeldSuarezTest::PerturbationType_StreamFn;
	} else {
...
*/
	model.SetTestCase(
		new HeldSuarezTest(
			dZtop,
			HeldSuarezTest::PerturbationType_Exp));
