...
try {
	...
	BeginCommandLine()
		CommandLineString(strOutputDir, "output_dir",
			"outNonHydroMountainCartesianTest");
		...
		CommandLineDouble(params.m_dEndTime, "endtime", 18000.0);
	...
	NonHydroMountainCartesianTest test(fNoRayleighFriction);
...
*/
	...
	NonHydroMountainCartesianTest ctest(fNoRayleighFriction);
