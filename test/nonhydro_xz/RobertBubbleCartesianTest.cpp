///////////////////////////////////////////////////////////////////////////////
///
///	\file    RobertBubbleCartesianTest.cpp
...
///	</summary>
class RobertBubbleCartesianTest : public TestCase {
...
try {
	...
	BeginTempestCommandLine("RobertBubbleCartesianTest");
		...
		CommandLineDouble(dzC, "zC", 260.0);
	...
	RobertBubbleCartesianTest * test =
		new RobertBubbleCartesianTest(
			dThetaBar,
			dThetaC,
			drC,
			dxC,
	...
	// Set the reference length to reduce diffusion (10km)
	model.GetGrid()->SetReferenceLength(10000.0);
